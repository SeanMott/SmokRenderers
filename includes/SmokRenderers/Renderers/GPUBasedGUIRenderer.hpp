...
//defines a GPU based GUI renderer
...
#define SMOK_RENDERER_CAMERA_BUFFER_ARRAY_LENGTH 4
	...
	{
		uint64 objIndex = 0; //the object index
	};
	...
	public:
		...
		inline void Shutdown()
		{
			...
			textureBuffer.textureSamplers.clear();
			textureBuffer.textureViews.clear();
